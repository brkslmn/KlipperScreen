...
class CoPrintPrintingScreen(ScreenPanel):
    ...
    def __init__(self, screen, title):
        ...
        #denemee
        self.start_timer()
        b = self._printer.get_heaters()
        for device in self._printer.get_temp_store_devices():
                self.labels[device] = Gtk.Label(label="100º")
                a = self._printer.get_temp_store(device)
                ac = self._printer.get_temp_store(device, True)
        ...
        main = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=0)
        main.pack_start(self.label1, True, True, 0)
        main.pack_start(self.label3, True, True, 0)
        main.pack_start(self.label4, True, True, 0)
        main.pack_start(self.label5, True, True, 0)
        main.pack_start(self.label6, True, True, 0)
        main.pack_start(self.label7, True, True, 0)
        main.pack_start(self.label8, True, True, 0)
        main.pack_start(self.label9, True, True, 0)
        main.pack_end(self.label2, True, True, 0)
