...
def create_panel(*args):
    return CoPrintMcuFlashChip(*args)
...
class CoPrintMcuFlashChip(ScreenPanel):
    ...
    def __init__(self, screen, title):
        ...
        initHeader = InitHeader (self, i18n.t('translate.flashChipHeader'), i18n.t('translate.flashChipContent'), "mikrochip")
    ...
    def on_click_continue_button(self, continueButton):
        self._screen.show_panel("co_print_baud_rate_selection", "co_print_baud_rate_selection", None, 2)
